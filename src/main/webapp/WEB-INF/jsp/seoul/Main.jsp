				...
				<div class="w-full max-w-full overflow-hidden flex flex-col gap-y-2">
					...
					<table class="text-xs md:text-sm w-full border-separate text-gray-600 px-2">
						<tbody id="shelterInfo">
							<tr>
								<th class="w-1/3 bg-gray-100 font-medium py-1 border">배포장소명</th>
								<td id="name_area_medicine" class="px-2 py-1 border">농협</td>
							</tr>
							<tr>
								<th class="bg-gray-100 font-medium py-1 border">주소</th>
								<td id="address_area_medicine" class="px-2 py-1 border">울산광역시 남구 중앙로 206</td>
							</tr>
							<tr>
								<th class="bg-gray-100 font-medium py-1 border">마을이름명</th>
								<td id="village_area_medicine" class="px-2 py-1 border">신정3동1통</td>
							</tr>
						</tbody>
					</table>
